define(['dart_sdk', 'packages/flutter_web_ui/ui', 'packages/flutter_web/io', 'packages/typed_data/typed_buffers'], function(dart_sdk, ui, io, typed_buffers) {
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.fn(src__foundation__binding._exitApplication, VoidToFutureOfvoid());
    },
    get C1() {
      return C1 = dart.const({
        __proto__: src__foundation__print._WordWrapParseMode.prototype,
        index: 0,
    ...
    get C4() {
      return C4 = dart.constList([C1 || CT.C1, C2 || CT.C2, C3 || CT.C3], src__foundation__print._WordWrapParseMode);
    },
    get C5() {
      return C5 = dart.fn(src__foundation__print._debugPrintTask, VoidTovoid());
    },
    get C6() {
      return C6 = dart.fn(src__foundation__print.debugPrintThrottled, String__Tovoid());
    },
    get C7() {
    ...
    get C8() {
      return C8 = dart.const({
        __proto__: src__foundation__platform.TargetPlatform.prototype,
        index: 0,
    ...
    get C11() {
      return C11 = dart.constList([C8 || CT.C8, C9 || CT.C9, C10 || CT.C10], src__foundation__platform.TargetPlatform);
    },
    get C12() {
    ...
    get C17() {
      return C17 = dart.constList([], src__foundation__diagnostics.DiagnosticsNode);
    },
    get C18() {
    ...
    get C32() {
      return C32 = dart.fn(src__foundation__assertions.FlutterError.dumpErrorToConsole, FlutterErrorDetails__Tovoid());
    },
    get C33() {
      return C33 = dart.fn(src__foundation__assertions.FlutterError.defaultStackFilter, IterableOfStringToIterableOfString());
    },
    get C34() {
      return C34 = dart.fn(src__foundation__assertions.DiagnosticsStackTrace._createStackFrame, StringToDiagnosticsNode());
    },
    get C35() {
    ...
    get C42() {
      return C42 = dart.constList([C35 || CT.C35, C36 || CT.C36, C29 || CT.C29, C14 || CT.C14, C37 || CT.C37, C38 || CT.C38, C39 || CT.C39, C40 || CT.C40, C41 || CT.C41], src__foundation__diagnostics.DiagnosticLevel);
    },
    get C43() {
      return C43 = dart.constList([C19 || CT.C19, C21 || CT.C21, C22 || CT.C22, C20 || CT.C20, C24 || CT.C24, C27 || CT.C27, C23 || CT.C23, C13 || CT.C13, C16 || CT.C16, C25 || CT.C25, C26 || CT.C26, C28 || CT.C28], src__foundation__diagnostics.DiagnosticsTreeStyle);
    },
    get C44() {
      return C44 = dart.const({
        __proto__: src__foundation__diagnostics._WordWrapParseMode.prototype,
        index: 0,
    ...
    get C47() {
      return C47 = dart.constList([C44 || CT.C44, C45 || CT.C45, C46 || CT.C46], src__foundation__diagnostics._WordWrapParseMode);
    },
    get C48() {
    ...
    get C49() {
      return C49 = dart.const({
        __proto__: src__foundation__licenses._LicenseEntryWithLineBreaksParserState.prototype,
        index: 0,
    ...
    get C51() {
      return C51 = dart.constList([C49 || CT.C49, C50 || CT.C50], src__foundation__licenses._LicenseEntryWithLineBreaksParserState);
    }
  });
      ...
      if (!dart.test(dart.fn(() => {
        ...
        this.registerServiceExtension({name: "platformOverride", callback: dart.fn(parameters => async.async(MapOfString$dynamic(), (function*() {
            if (dart.test(parameters[$containsKey]("value"))) {
              ...
              this[_postExtensionStateChangedEvent]("platformOverride", dart.toString(src__foundation__platform.defaultTargetPlatform)[$substring]((dart.str(dart.wrapType(src__foundation__platform.TargetPlatform)) + ".").length));
  ...
  src__foundation__print._WordWrapParseMode.inSpace = C1 || CT.C1;
  src__foundation__print._WordWrapParseMode.inWord = C2 || CT.C2;
  src__foundation__print._WordWrapParseMode.atBreak = C3 || CT.C3;
  src__foundation__print._WordWrapParseMode.values = C4 || CT.C4;
  let C5;
  ...
  src__foundation__print._debugPrintTask = function _debugPrintTask() {
    ...
    if (dart.test(src__foundation__print._debugPrintBuffer[$isNotEmpty])) {
      ...
      src__foundation__print._debugPrintedCharacters = 0;
      async.Timer.new(src__foundation__print._kDebugPrintPauseTime, C5 || CT.C5);
  ...
  src__foundation__platform.TargetPlatform.android = C8 || CT.C8;
  src__foundation__platform.TargetPlatform.fuchsia = C9 || CT.C9;
  src__foundation__platform.TargetPlatform.iOS = C10 || CT.C10;
  src__foundation__platform.TargetPlatform.values = C11 || CT.C11;
  ...
  src__foundation__diagnostics.DiagnosticsNode = class DiagnosticsNode extends core.Object {
    ...
    get level() {
      return false ? src__foundation__diagnostics.DiagnosticLevel.hidden : src__foundation__diagnostics.DiagnosticLevel.info;
    }
  ...
  src__foundation__diagnostics.DiagnosticsProperty$ = dart.generic(T => {
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      if (!(dart.equals(defaultValue, src__foundation__diagnostics.kNoDefaultValue) || T.is(defaultValue))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2508, 15, "n exception, [level]\r\n  /// will always return [Diag");
  ...
  (src__foundation__assertions.DiagnosticsStackTrace.new = function(name, stack, opts) {
    ...
    let stackFilter = opts && 'stackFilter' in opts ? opts.stackFilter : null;
    let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
    src__foundation__assertions.DiagnosticsStackTrace.__proto__.new.call(this, {name: name, value: stack, properties: (t6 = stackFilter, t6 == null ? C33 || CT.C33 : t6)(dart.toString(stack)[$trimRight]()[$split]("\n"))[$map](src__foundation__diagnostics.DiagnosticsNode, C34 || CT.C34)[$toList](), style: src__foundation__diagnostics.DiagnosticsTreeStyle.flat, showSeparator: showSeparator, allowTruncate: true});
    ;
  ...
  src__foundation__diagnostics.DiagnosticableNode$ = dart.generic(T => {
    class DiagnosticableNode extends src__foundation__diagnostics.DiagnosticsNode {
      ...
      get style() {
        let t6;
        return false ? src__foundation__diagnostics.DiagnosticsTreeStyle.none : (t6 = super.style, t6 == null ? this.builder.defaultDiagnosticsTreeStyle : t6);
      }
      get emptyBodyDescription() {
  ...
  src__foundation__diagnostics.DiagnosticLevel.hidden = C35 || CT.C35;
  src__foundation__diagnostics.DiagnosticLevel.fine = C36 || CT.C36;
  src__foundation__diagnostics.DiagnosticLevel.debug = C29 || CT.C29;
  src__foundation__diagnostics.DiagnosticLevel.info = C14 || CT.C14;
  src__foundation__diagnostics.DiagnosticLevel.warning = C37 || CT.C37;
  src__foundation__diagnostics.DiagnosticLevel.hint = C38 || CT.C38;
  src__foundation__diagnostics.DiagnosticLevel.summary = C39 || CT.C39;
  src__foundation__diagnostics.DiagnosticLevel.error = C40 || CT.C40;
  src__foundation__diagnostics.DiagnosticLevel.off = C41 || CT.C41;
  src__foundation__diagnostics.DiagnosticLevel.values = C42 || CT.C42;
  let C43;
  ...
  src__foundation__diagnostics.DiagnosticsTreeStyle.none = C19 || CT.C19;
  src__foundation__diagnostics.DiagnosticsTreeStyle.sparse = C21 || CT.C21;
  src__foundation__diagnostics.DiagnosticsTreeStyle.offstage = C22 || CT.C22;
  src__foundation__diagnostics.DiagnosticsTreeStyle.dense = C20 || CT.C20;
  src__foundation__diagnostics.DiagnosticsTreeStyle.transition = C24 || CT.C24;
  src__foundation__diagnostics.DiagnosticsTreeStyle.error = C27 || CT.C27;
  src__foundation__diagnostics.DiagnosticsTreeStyle.whitespace = C23 || CT.C23;
  src__foundation__diagnostics.DiagnosticsTreeStyle.flat = C13 || CT.C13;
  src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine = C16 || CT.C16;
  src__foundation__diagnostics.DiagnosticsTreeStyle.errorProperty = C25 || CT.C25;
  src__foundation__diagnostics.DiagnosticsTreeStyle.shallow = C26 || CT.C26;
  src__foundation__diagnostics.DiagnosticsTreeStyle.truncateChildren = C28 || CT.C28;
  src__foundation__diagnostics.DiagnosticsTreeStyle.values = C43 || CT.C43;
  ...
  src__foundation__diagnostics._WordWrapParseMode.inSpace = C44 || CT.C44;
  src__foundation__diagnostics._WordWrapParseMode.inWord = C45 || CT.C45;
  src__foundation__diagnostics._WordWrapParseMode.atBreak = C46 || CT.C46;
  src__foundation__diagnostics._WordWrapParseMode.values = C47 || CT.C47;
  ...
  src__foundation__licenses._LicenseEntryWithLineBreaksParserState.beforeParagraph = C49 || CT.C49;
  src__foundation__licenses._LicenseEntryWithLineBreaksParserState.inParagraph = C50 || CT.C50;
  src__foundation__licenses._LicenseEntryWithLineBreaksParserState.values = C51 || CT.C51;
